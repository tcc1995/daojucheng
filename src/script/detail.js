...
//     //2.将sid传给后端
//     $.ajax({
//         url: 'http://localhost/phpJop/daojucheng/php/getsid.php',
//         data: {
//             sid: $sid
//         },
//         dataType: 'json'
...
!function($){
    ...
    $spic.hover(function(){//移入
        ...
        $(this).on('mousemove',function(e){
            let $leftvalue = e.pageX - $scale.offset().left - $sf.outerWidth() / 2;
            let $topvalue = e.pageY - $scale.offset().top - $sf.outerHeight() / 2;
            if ($leftvalue < 0) {
                $leftvalue = 0
